---
publish: true
title: Obsidian DataView 入门保姆级引导手册
description: DataView 查询语法```dataview <QUERY-TYPE> <WITHOUT ID> <字段> FROM <来源> <WHERE> <条件表达式> <SORT> <排序依据 排序方式> <GROUP BY> <分组依…
created: 2025-06-27
modified: 2026-02-07T22:42:37.746+08:00
tags:
  - clippings
cssclasses: ""
---
...
| file.tags | List | 文中的 #标签 和 [YAML](https://zhida.zhihu.com/search?content_id=224771915&content_type=Article&match_order=1&q=YAML&zhida_source=entity) 中的 tags |
...
| Date | 由日期和时间组成，遵循 ISO 8601 标准   格式为 YYYY-MM\[-DDTHH:mm:ss.nnn+ZZ\] | 2021-04-18 |
...
发布于 2023-03-17 20:12・广东[Obsidian](https://www.zhihu.com/topic/21349840)
