---
{"publish":true,"title":"🏗 本库Roadmap","created":"2025-07-11T01:39:38.000+08:00","modified":"2026-02-07T18:03:59.109+08:00","tags":["todo/本周"],"cssclasses":""}
---
...
- 把历史已发布过的笔记，通过[[publish_by_frontmatter.py]]脚本重新整理push到[[knowledge-garden]]，同时，使用[[Cards/quartz syncer]]，更方便地实时更新[[garden.oldwiner.top]].
...
- 完成[[§ 如何成为学习高手 - 高冷冷]]课程的学习笔记，作为[[🍀 花园导览/🧰 本库指南/Obsidian/obsidian相关笔记/obsidian如何做短课程笔记]]的实践探索
...
- 完成[[🍀 花园导览/🧰 本库指南/🧰 本库使用指南]]的更细致的引导内容，[[Spaces/Published/已发布文章/obsidian 不可回避的缺点及其解决方案]]，并更新自己常用的插件列表[[Spaces/Published/已发布文章/2022年7月，obsidian 依然必装的 10 个插件]]，[[∑ obsidian插件]]。
