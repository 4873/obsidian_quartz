---
{"publish":true,"title":"如果要我安利obsidian给别人，我会怎么做","created":"2025-07-11T01:39:38.000+08:00","modified":"2026-02-07T18:04:00.387+08:00","cssclasses":""}
---
...
- 如果有演示的机会，或者做视频表达
	...
	- [[Cards/双链笔记]]和[[Spaces/3-Resource/软件梳理/macos软件/Obsidian]]如何优雅地解决
		...
		- [[Spaces/3-Resource/软件梳理/macos软件/Obsidian]]独有
			- 社区插件实现[[Anki]]复习系统。以及强大社区引发的各种奇妙增强，带来[[Cards/渐进式学习]]的感觉。
				- [[Anki]]集成
				- [[Outliner]]大纲笔记
	...
	- 缺点及解决方案
		...
		- 解决方案
			- 干脆不用。需要备份就 git 自动定时 push 就行。写笔记的云同步，其实有时候是伪需求。把 obsdian 的作用收窄，只作为[[Spaces/2-Area/知识管理/个人知识笔记系统]]，而不是[[Spaces/2-Area/知识管理/个人信息管理系统]]，[[个人任务管理系统]]或[[个人输出发布系统]]。[[Cards/重器轻用]]，obsidian 可以通过社区插件实现所有系统的闭环，但没必要，也太折腾。社区的 sync 插件终极解决。
